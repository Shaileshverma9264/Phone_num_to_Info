...
function App() {
  ...
  const login = async (e) => {
    ...
    try {
      /*
        ...
        should be done on your backend.
      */
  ...
  return <SearchPage token={token} logout={logout} />;
}
...
function SearchPage({ token, logout }) {
  ...
  const searchMobile = async (e) => {
    ...
    try {
      ...
      const url = `${SEARCH_API_BASE}&num=${encodeURIComponent(mobile)}`;
          ...
          <div className="results-container">
            ...
            {results.map((record, index) => (
              <div className="result" key={index}>
                ...
                <Info label="👨 Father" value={record.father} />

                <Info label="📡 Circle" value={record.circle} />

                <Info
                  label="🏠 Address"
                  value={
                    record.address ? record.address.replace(/!/g, ", ") : ""
                  }
                />
                <Info
                  label="🏠 Aadhar Id"
                  value={record.id ? record.id.replace(/!/g, ", ") : ""}
                />
              </div>
            ))}
          </div>
